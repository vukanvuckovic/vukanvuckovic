...
I build modern web applications — from SaaS platforms to complex 
data-driven interfaces — with a strong focus on UI/UX quality and 
clean, maintainable code.

## What I'm working on
- 🐾 **Apawintment** — a multi-tenant appointment scheduling SaaS 
  for veterinary practices, live and onboarding clients
- ⚡ **SkyCaster** — weather broadcasting platform for live TV 
  programs
